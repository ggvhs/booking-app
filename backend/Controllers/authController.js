...
export const register = async(req,res) =>{
    ...
    try {
        ...
        await user.save()
        res.status(200).json({success:true,message:`User successfully created :D`})
...
export const login = async(req,res) =>{
    ...
    try {
        ...
        res.status(200).json({status:true, message: "Successfull login rawwwrr XD" , token , data:{...rest}, role});
