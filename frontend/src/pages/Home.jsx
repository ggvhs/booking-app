            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text__para">
                  ...
                  Distinctio repellendus alias minima aperiam inventore non a
                  molestias suscipit itaque eligendi.
                </p>
        ...
        <div className="container">
          <div className="xl:w-[470] mx-auto">
            ...
            <p className="text__para text-center">
              ...
              at, saepe iure voluptas illo voluptatum.
            </p>
          </div>
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px]
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                    ...
                    <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor">Wayne Collions</h4>
                </div>
              </div>
            </div>
          </div>
