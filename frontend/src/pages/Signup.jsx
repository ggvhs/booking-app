            ...
            <div className="mb-5 flex items-center gap-3">
              ...
              <div className="relative w-[130px] h-[50px]">
                <input
                  ...
                  accept=".jpg, .png"
                  className="absolute top-0 left-0 w-full h-ful opacity-0 cursor-pointer"
                />

                <label htmlFor="customFile" className="absolute top-0 left-0 w-full h-full flex items-center 
                px-[.75rem] py-[.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor 
